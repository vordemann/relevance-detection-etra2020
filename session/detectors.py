...
def fixation_detection(x, y, time, missing=0.0, maxdist=MAXIMAL_DISTANCE, mindur=MINIMAL_DURATION):
...
def saccade_detection(x, y, time, missing=0.0, minlen=6, maxvel=40, maxacc=340):
